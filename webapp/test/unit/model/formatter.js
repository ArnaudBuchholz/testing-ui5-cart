...
sap.ui.define([
	...
	QUnit.module("totalPrice", function () {
	...
	QUnit.module("statusText", function () {
	...
	QUnit.module("statusState", function () {
	...
	QUnit.module("pictureUrl", function () {
		QUnit.test("Should return the url to a product picture relative to the app's root directory", function (assert) {
			...
			assert.strictEqual(sResult, "../../test-resources/sap/ui/documentation/sdk/images/foo.jpg", "The formatter returned the correct URL");
		});
	});

	QUnit.module("footerTextForCart", function () {
